"""
Profile Numpy definitions. This profile is optimized for fast performance, using Numpy arrays and Numba. Because of
that it is maybe not very comprehensible. ProfileNative does the same with Python native classes and is therefore
...
from f3atur3s import Feature, FeatureGrouper, TIME_PERIODS
