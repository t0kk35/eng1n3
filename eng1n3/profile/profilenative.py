"""
Profile Native definitions. This is a simple profile class. It's not used in the code as not very efficient. But
it can be a helpful reference, and it is used for testing
(c) 2023 tsm
"""
import logging
...
from f3atur3s import FeatureGrouper, Aggregator, TimePeriod
from f3atur3s import Feature, FeatureFilter
