...
class TestNP(unittest.TestCase):
    def test_from_np_good(self):
        ...
        td1 = ft.TensorDefinition('TestNP1', [fr])
        td2 = ft.TensorDefinition('TestNP2', [fr])
        with en.EnginePandas(num_threads=1) as e:
        ...
        self.assertEqual(td1.rank, td2.rank, f'Expecting Rank to be the same {td1.rank} {td2.rank}')
