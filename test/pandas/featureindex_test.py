...
class TestIndex(unittest.TestCase):
    ...
    def test_read_base_non_inference(self):
        ...
        with en.EnginePandas(num_threads=1) as e:
            ...
            self.assertListEqual(sorted(list(fi.dictionary.keys())), sorted(list(mcc_v) + ['UNK']))
            ...
            self.assertListEqual(sorted(list(fi.index_to_label.values())), sorted(list(mcc_v) + ['UNK']))
